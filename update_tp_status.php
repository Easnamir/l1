			...
			<div class="w3-col">
				<div class="w3-col l8">
					<h3>Update TP</h3>
						...
						<div class="w3-col l2 w3-padding-small">
							<label for="tp_number">Tp Number<span class="w3-text-red">*</span></label>
              ...
              <option value="TP on Hold">TP on Hold</option>
						...
						<!-- <div class="w3-col l5 w3-padding-small">
							<label for="tp_number">Remark<span class="w3-text-red">*</span></label>
						...
						<button class="w3-button w3-round w3-red tohide" onclick="updateTPStatus()" name="submit" type="button" id="submit" >Submit</button>
...
// 		}	
		...
		tp_num.addEventListener('change', function(){			
			let url = 'status_query.php?fun=checkTpstatusTP&tp_num='+tp_num.value;
			fetch(url).then(data=>data.json()).then(data=>{
				...
				console.log(data);
				 document.getElementById('tp_status').value=data[0].MANUAL_STATUS?data[0].MANUAL_STATUS:'';
		...
		function updateTPStatus(){
			...
			let url = 'status_query.php?fun=updateTPStatus';
			// console.log(url);
